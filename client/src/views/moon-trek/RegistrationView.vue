<script setup>
import ModelGenerator from '../../components/moon-trek/ModelGenerator.vue'
import { ref } from 'vue'
import { data } from '../../components/trekData.js'
...
const getUrl = (type) => {
    if (type === 'resized') {
        return `https://www.YoussefElzein.com/static/processed/${type}-${data.relativeImageName}`
    } else {
        return `https://www.YoussefElzein.com/static/processed/${type}-${algorithm.value}-${data.relativeImageName}`
    }
}
</script>
