<script setup>
import BasicMoon from '../../components/moon-trek/BasicMoon.vue'
</script>
    ...
    <main>
        <div class="columns is-centered">
            <div class="column has-text-centered is-11">
                ...
                <h2>Apply data from Nasa JPL to your images of the Moon!</h2>
            </div>
        </div>
        ...
        <div class="columns is-centered">
            <div class="column has-text-centered">
                <router-link to="moon-trek/upload"> Get Started </router-link>
            </div>
        </div>
    </main>
</template>
